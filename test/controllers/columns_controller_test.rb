...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { image: @column.image, text: @column.text, title: @column.title } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { image: @column.image, text: @column.text, title: @column.title } }
